...
const AboutMe = () => {
    ...
    return (
        <div id='aboutme' className="animated-border rounded-lg w-full md:w-3/4 max-w-[95%] mx-auto mt-3 sm:mt-6">
            <div className='flex-grow bg-darkSecondary p-4 sm:p-6 flex flex-col md:flex-row justify-start items-center gap-4 sm:gap-8'>
