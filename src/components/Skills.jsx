...
const Skills = () => {
    return (
        <div
            id='skills'
            className='flex-grow bg-darkSecondary w-full md:w-3/4 max-w-[95%] mx-auto mt-3 sm:mt-6 p-4 sm:p-6 rounded-lg flex flex-col justify-center items-center gap-4 sm:gap-8 min-h-[400px]'
        >
            {/* Title */}
            ...
            {/* Responsive Layout */}
            <div className='flex flex-col md:flex-row justify-center items-stretch  md:items-stretch  gap-6 md:gap-8 w-full'>
