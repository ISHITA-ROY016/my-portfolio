    ...
    return (
        <div className="overflow-hidden">
            <div className="container_education">
                <div className="text it1 text-base md:text-lg md:font-semibold text-text dark:text-white" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="500">2017-2018</div>
                ...
                <div className="text1 it5" data-aos="fade-left" data-aos-easing="linear" data-aos-duration="500">
                    ...
                    <div data-aos="fade-left" data-aos-delay="250" className="text-lg md:text-xl font-bold text-text dark:text-white">R. K. S. M. Sister Nivedita Girls’ School</div>
                ...
                <div className="text it6 text-base md:text-lg md:font-semibold text-text dark:text-white" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="500">2019-2020</div>
                ...
                <div className="text1 it10" data-aos="fade-left" data-aos-easing="linear" data-aos-duration="500">
                    ...
                    <div data-aos="fade-left" data-aos-delay="250" className="text-lg md:text-xl font-bold text-text dark:text-white">Bidhannagar Govt. High School</div>
                ...
                <div className="text it11 text-base md:text-lg md:font-semibold text-text dark:text-white" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="500">2020-2024</div>
                ...
                <div className="text1 it15" data-aos="fade-left" data-aos-easing="linear" data-aos-duration="500">
                    ...
                    <div data-aos="fade-left" data-aos-delay="250" className="text-lg md:text-xl font-bold text-text dark:text-white">Academy of TecTechnology</div>
